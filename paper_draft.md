...
执行流程：R14 预评估 → R13 模式匹配 → R11/R12 结构搜索 → Bootstrap → R14 后评估
...
### 8.1 最新进展：R11→R14 搜索策略演进

针对 OMP 贪心选择与乘法/除法结构的本质冲突，我们提出四层渐进式搜索策略：
